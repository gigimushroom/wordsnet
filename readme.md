*wordsnet is a app that returns you random words every time you request it.*
...
Writer:
Follow https://github.com/patrickbucher/ox to build your Go CLI for the Oxford Dictionary API
